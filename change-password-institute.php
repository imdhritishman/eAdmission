<?php
    ...
    require("header.php");
    $page_title = "Institute Change Password";
    ...
    if(isset($_POST['submit_change_password_institute'])){
      if(($_POST['ins_newpassword']===$_POST['ins_confirmpassword']) && (md5($_POST['ins_previouspassword'])==$info_institute['ins_password'])){
        $ins_previouspassword = md5($_POST['ins_previouspassword']);
        $ins_newpassword = md5($_POST['ins_newpassword']);
        $ins_confirmpassword = md5($_POST['ins_confirmpassword']);
        
        $sql_change_password_institute = "UPDATE `institute` SET `ins_password`='$ins_newpassword' WHERE `ins_id`='$ins_id'";
        $result_change_password_institute = mysqli_query($connect, $sql_change_password_institute);
        
        if($result_change_password_institute){
          ?>
            <script>
              window.location.href="global-assets/php/change-password-institute-success.php";
            </script>
          <?php
        }
      }
      ?>
      <script>
        window.location.href="global-assets/php/change-password-institute-fail.php";
      </script>
      <?php
  }
...
<head>
    ...
    <link rel="stylesheet" href="css/change-password-institute.css">
</head>
...
<main class="l-main">
  <div class="content-wrapper content-wrapper--with-bg">
    ...
    <div class="page-content">
      <form action="change-password-institute.php" method="post" autocomplete="off">
        <div class="form-row">
          <div class="form-group col-md-4">
            <label for="InputPreviousPassword">Previous Password<span style="color:red; font-weight:bold; font-size: medium;"> *</span></label>
              <input class="form-control" type="password" name="ins_previouspassword" required>
          ...
          <div class="form-group col-md-4">
            <label for="InputNewPassword">New Password<span style="color:red; font-weight:bold; font-size: medium;"> *</span></label>
              <input class="form-control" type="password" name="ins_newpassword" required>
          ...
          <div class="form-group col-md-4">
            <label for="InputConfirmPassword">Confirm Password<span style="color:red; font-weight:bold; font-size: medium;"> *</span></label>
              <input class="form-control" type="password" name="ins_confirmpassword" required>
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-12" style="text-align:right">
            <button type="submit" name="submit_change_password_institute" class="btn btn-success">Change Password</button>
          </div>
        </div>
      </form>
    </div>
...
<script src="js/change-password-institute.js"></script>
