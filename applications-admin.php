<?php
    ...
    $sql_total_applications = "SELECT * FROM registration_details";
    ...
    $info_total_applications = mysqli_fetch_all($result_total_applications, MYSQLI_ASSOC);
?>
...
<head>
    ...
    <link rel="stylesheet" href="css/applications-admin.css">
    <!-- Datable CSS/JS -->
...
<main class="l-main">
  <div class="content-wrapper content-wrapper--with-bg">
    ...
    <div class="page-content">
      <div class="table-responsive">
        <table id="myTable" class="display table" width="100%">
          ...
          <tbody>
              <?php foreach ($info_total_applications as $applications) { 
                ...
                if($applications['s_aplstatus1']==0){
                  $s_aplstatus1 = "Pending";
                }elseif($applications['s_aplstatus1']==1){
                  $s_aplstatus1 = "Verified";
                }elseif($applications['s_aplstatus1']==2){                
                  $s_aplstatus1 = "Rejected";
                }elseif($applications['s_aplstatus1']==3){                
                  $s_aplstatus1 = "Admission Confirmed";
                }

                if($applications['s_aplstatus2']==0){
                  $s_aplstatus2 = "Pending";
                }elseif($applications['s_aplstatus2']==1){
                  $s_aplstatus2 = "Verified";
                }elseif($applications['s_aplstatus2']==2){                
                  $s_aplstatus2 = "Rejected";
                }elseif($applications['s_aplstatus2']==3){                
                  $s_aplstatus2 = "Admission Confirmed";
                }

                if($applications['s_aplstatus3']==0){
                  $s_aplstatus3 = "Pending";
                }elseif($applications['s_aplstatus3']==1){
                  $s_aplstatus3 = "Verified";
                }elseif($applications['s_aplstatus3']==2){                
                  $s_aplstatus3 = "Rejected";
                }elseif($applications['s_aplstatus3']==3){                
                  $s_aplstatus1 = "Admission Confirmed";
                }
              ...
              <tr>
                ...
                <td><?php echo $applications['s_aplno1'] ?></td>
                <td><?php echo $s_aplstatus1 ?></td>
                <td><?php echo $applications['s_aplno2'] ?></td>
                <td><?php echo $s_aplstatus2 ?></td>
                <td><?php echo $applications['s_aplno3'] ?></td>
                <td><?php echo $s_aplstatus3 ?></td>
                <td><?php echo $progress ?></td>
                <td><i class="fa fa-trash" id="print-icon" style="font-size: 24px;" onclick="deleteApplicationAdmin('<?php echo $applications['s_id'] ?>')"></i></td>
                <td><i class="fa fa-print" id="print-icon" style="font-size: 24px;" onclick="viewApplicationAdmin('<?php echo $applications['s_id'] ?>')"></i></td>
              </tr>
            <?php } ?>
          </tbody>
        </table>
    ...
    <div style="text-align: center;">
      <button type="button" class="btn btn-primary" onclick="viewApplicationDatabase()"><i class="fa fa-print" style="font-size: 14px;"></i>&nbsp; Print Database</button>
    </div>
  </div>
</main>
...
<script src="js/applications-admin.js"></script>
