<?php
    ...
    if(isset($_POST['submit_change_password_admin'])){
      if(($_POST['adm_newpassword']===$_POST['adm_confirmpassword']) && (md5($_POST['adm_previouspassword'])==$info_admin['adm_password'])){
        $adm_previouspassword = md5($_POST['adm_previouspassword']);
        $adm_newpassword = md5($_POST['adm_newpassword']);
        $adm_confirmpassword = md5($_POST['adm_confirmpassword']);
        
        $sql_change_password_admin = "UPDATE `admin` SET `adm_password`='$adm_newpassword' WHERE `adm_id`='$adm_id'";
        $result_change_password_admin = mysqli_query($connect, $sql_change_password_admin);
        
        if($result_change_password_admin){
          ?>
            <script>
              window.location.href="global-assets/php/change-password-admin-success.php";
            </script>
          <?php
        }
      }
      ?>
      <script>
        window.location.href="global-assets/php/change-password-admin-fail.php";
      </script>
      <?php
  }
...
<head>
    ...
    <link rel="stylesheet" href="css/change-password-admin.css">
    <!-- Datable CSS/JS -->
...
<main class="l-main">
  <div class="content-wrapper content-wrapper--with-bg">
    ...
    <div class="page-content">
      <form action="change-password-admin.php" method="post" autocomplete="off">
        <div class="form-row">
          <div class="form-group col-md-4">
            <label for="InputPreviousPassword">Previous Password<span style="color:red; font-weight:bold; font-size: medium;"> *</span></label>
              <input class="form-control" type="password" name="adm_previouspassword" required>
          ...
          <div class="form-group col-md-4">
            <label for="InputNewPassword">New Password<span style="color:red; font-weight:bold; font-size: medium;"> *</span></label>
              <input class="form-control" type="password" name="adm_newpassword" required>
          ...
          <div class="form-group col-md-4">
            <label for="InputConfirmPassword">Confirm Password<span style="color:red; font-weight:bold; font-size: medium;"> *</span></label>
              <input class="form-control" type="password" name="adm_confirmpassword" required>
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-12" style="text-align:right">
            <button type="submit" name="submit_change_password_admin" class="btn btn-success">Change Password</button>
          </div>
        </div>
      </form>
    </div>
...
<script src="js/change-password-admin.js"></script>
