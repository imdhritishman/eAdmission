          ...
          <tbody>
            <?php foreach ($info_applications as $applications) {
              ...
              <tr>
                ...
                <?php if($s_status==0){ ?>
                  <td><i class="fa fa-exclamation-circle" id="pending-icon" style="font-size: 24px;" onclick="approveApplication('<?php echo $sl ?>','<?php echo $applications['s_id'] ?>')"></i></td>
                <?php }elseif($s_status==1){ ?>
                  <td><i class="fa fa-check" id="verified-icon" style="font-size: 24px;" onclick="approveApplication('<?php echo $sl ?>','<?php echo $applications['s_id'] ?>')"></i></td>  
                <?php }elseif($s_status==2){ ?>
                  <td><i class="fa fa-times" id="rejected-icon" style="font-size: 24px;" onclick="approveApplication('<?php echo $sl ?>','<?php echo $applications['s_id'] ?>')"></i></td>
