<?php
    ...
    if((isset($_SESSION['adm_id'])) && (isset($_GET['std_id']))){
    ...
    if($info_registration['s_aplstatus1']==0){
        $aplstatus1 = "Pending";
    }elseif($info_registration['s_aplstatus1']==1){
        $aplstatus1 = "Verified";
    }elseif($info_registration['s_aplstatus1']==2){
        $aplstatus1 = "Rejected";
    }elseif($info_registration['s_aplstatus1']==3){
        $aplstatus1 = "Admission Confirmed";
    }

    if($info_registration['s_aplstatus2']==0){
        $aplstatus2 = "Pending";
    }elseif($info_registration['s_aplstatus2']==1){
        $aplstatus2 = "Verified";
    }elseif($info_registration['s_aplstatus2']==2){
        $aplstatus2 = "Rejected";
    }elseif($info_registration['s_aplstatus2']==3){
        $aplstatus2 = "Admission Confirmed";
    }

    if($info_registration['s_aplstatus3']==0){
        $aplstatus3 = "Pending";
    }elseif($info_registration['s_aplstatus3']==1){
        $aplstatus3 = "Verified";
    }elseif($info_registration['s_aplstatus3']==2){
        $aplstatus3 = "Rejected";
    }elseif($info_registration['s_aplstatus3']==3){
...
<head>
    ...
    <link rel="stylesheet" href="css/application-form-admin.css">
</head>
<body>
    <div class="page-header">
        ...
        <div class="page-title-text">
            <span style="font-weight: bold; font-size:large;">Application Data - eAdmission</span><br>
        </div>
    </div>
    <div class="application-data">
        ...
        <table class="registration-details">
            ...
            <tr>
                <td class="left">Application Status</td>
                <td class="right"><?php echo $aplstatus2 ?></td>
            </tr>
            <tr>
                <td class="left">Preferred Institute-3</td>
            ...
            <tr>
                <td class="left">Application Status</td>
                <td class="right"><?php echo $aplstatus3 ?></td>
            </tr>
        </table>
...
<script src="js/application-form-admin.js"></script>
