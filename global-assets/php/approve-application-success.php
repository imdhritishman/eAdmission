...
<main class="l-main">
  <div class="content-wrapper content-wrapper--with-bg">
    ...
    <div class="text-center">
        <h2 style="margin-bottom: 50px;">Application Approval Changed Successfully!</h2>
        <button type="button" class="btn btn-success" style="font-size:large" onclick="window.location.href='../../applications.php'">Continue</button>
    </div>
  </div>
</main>
