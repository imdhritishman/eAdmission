...
<main class="l-main">
  <div class="content-wrapper content-wrapper--with-bg">
    ...
    <div class="text-center">
        <h2 style="margin-bottom: 50px;">Institute Code isn't provided!</h2>
        <button type="button" class="btn btn-danger" style="font-size:large" onclick="window.location.href='../../institutes-admin.php'">Try Again</button>
    </div>
  </div>
</main>
