<?php
    ...
    $sql_students = "SELECT * FROM student WHERE `std_institute` = '$ins_name'";
...
<main class="l-main">
  <div class="content-wrapper content-wrapper--with-bg">
        ...
        <table id="myTable" class="display table" width="100%">
          <thead>
            <tr>
              ...
              <th style="text-align:center">Entrollment No</th>
          ...
          <tbody>
              ...
              <tr>
                ...
                <td style="vertical-align: middle;"><img src="<?php echo $info_upload_documents['s_passportphotograph'] ?>" height="100px" width="100px"></td>
    ...
    <div style="text-align: center;">
      <button type="button" class="btn btn-primary" onclick="viewStudentsDatabase('<?php echo $ins_id ?>')"><i class="fa fa-print" style="font-size: 14px;"></i>&nbsp; Print Database</button>
    </div>
  </div>
</main>
