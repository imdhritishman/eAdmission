<?php
    ...
    $ins_name1 = $info_registration['s_institute1'];
    $sql_institute1 = "SELECT * FROM institute WHERE `ins_name` = '$ins_name1'";
    ...
    $ins_code1 = $info_institute1['ins_code'];
    $s_aplno1 = $ins_code1.$year.rand(100000,999999);

    $ins_name2 = $info_registration['s_institute2'];
    $sql_institute2 = "SELECT * FROM institute WHERE `ins_name` = '$ins_name2'";
    ...
    $ins_code2 = $info_institute2['ins_code'];
    $s_aplno2 = $ins_code2.$year.rand(100000,999999);

    $ins_name3 = $info_registration['s_institute3'];
    $sql_institute3 = "SELECT * FROM institute WHERE `ins_name` = '$ins_name3'";
    ...
    $ins_code3 = $info_institute3['ins_code'];
    $s_aplno3 = $ins_code3.$year.rand(100000,999999);
    ...
    if($info_upload['s_passportphotograph']=="" && $info_registration['s_status']=='9'){
        if(isset($_POST['submit_upload_documents'])){
            ...
            elseif (in_array($s_passportphotograph_actual_extention, $s_extensions) && ($s_passportphotograph_size < $s_size) && ($info_registration['s_course']=="Under Graduate")){
              ...
              $sql_upload_update = "UPDATE `upload_documents` SET `s_passportphotograph`='$s_passportphotograph_location',`s_signature`='$s_signature_location',`s_hslccertificate`='$s_hslccertificate_location',`s_hslcmarksheet`='$s_hslcmarksheet_location',`s_hscertificate`='$s_hscertificate_location',`s_hsmarksheet`='$s_hsmarksheet_location',`s_bankpassbook`='$s_bankpassbook_location',`s_domicilecertificate`='$s_domicilecertificate_location',`s_aadhaarcard`='$s_aadhaarcard_location' WHERE `s_id`='$s_id'";
              $result_upload_update = mysqli_query($connect, $sql_upload_update);
            ...
            elseif (in_array($s_passportphotograph_actual_extention, $s_extensions) && ($s_passportphotograph_size < $s_size) && ($info_registration['s_course']=="Post Graduate")){
              ...
              $sql_upload_update = "UPDATE `upload_documents` SET `s_passportphotograph`='$s_passportphotograph_location',`s_signature`='$s_signature_location',`s_hslccertificate`='$s_hslccertificate_location',`s_hslcmarksheet`='$s_hslcmarksheet_location',`s_hslcmarksheet`='$s_hslcmarksheet_location',`s_hscertificate`='$s_hscertificate_location',`s_hsmarksheet`='$s_hsmarksheet_location',`s_ugcertificate`='$s_ugcertificate_location',`s_ugmarksheet`='$s_ugmarksheet_location',`s_bankpassbook`='$s_bankpassbook_location',`s_domicilecertificate`='$s_domicilecertificate_location',`s_aadhaarcard`='$s_aadhaarcard_location' WHERE `s_id`='$s_id'";
              $result_upload_update = mysqli_query($connect, $sql_upload_update);
          ...
          $sql_registration_update = "UPDATE `registration_details` SET `s_status`='10',`s_aplno1`='$s_aplno1',`s_aplno2`='$s_aplno2',`s_aplno3`='$s_aplno3',`s_apldate`='$date' WHERE `s_id`='$s_id'";
          $result_registration_update = mysqli_query($connect, $sql_registration_update);

            if($result_upload_update && $result_registration_update){
              ?>
                <script>
                  window.location.href="global-assets/php/application-submit-success.php";
                </script>
              <?php
            }
          }
...
<main class="l-main">
  <div class="content-wrapper content-wrapper--with-bg">
    ...
    <div class="page-content">
      <form action="upload-documents.php" method="post" autocomplete="off" enctype="multipart/form-data">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">              
              <?php if($info_upload['s_passportphotograph']=="") { ?>
                <input class="form-control" type="file" name="s_passportphotograph" accept="image/jpg, image/jpeg, image/png" onchange="readURL(this);" required>
              <?php } else { ?>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              <?php if($info_upload['s_signature']=="") { ?>
                <input class="form-control" type="file" name="s_signature" accept=".jpg, .jpeg, .png" onchange="readURL1(this);" required>
              <?php } else { ?>
                <input class="form-control" type="file" disabled>
              <?php } ?>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                <?php if($info_upload['s_hslccertificate']=="") { ?>
                  <input class="form-control" type="file" name="s_hslccertificate" accept=".pdf" required>
                <?php } else { ?>
                  <input class="form-control" type="file" disabled>
                <?php } ?>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                <?php if($info_upload['s_hslcmarksheet']=="") { ?>
                  <input class="form-control" type="file" name="s_hslcmarksheet" accept=".pdf" required>
                <?php } else { ?>
                  <input class="form-control" type="file" disabled>
                <?php } ?>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                <?php if($info_upload['s_hscertificate']=="") { ?>
                  <input class="form-control" type="file" name="s_hscertificate" accept=".pdf" required>
                <?php } else { ?>
                  <input class="form-control" type="file" disabled>
                <?php } ?>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                <?php if($info_upload['s_hsmarksheet']=="") { ?>
                  <input class="form-control" type="file" name="s_hsmarksheet" accept=".pdf" required>
                <?php } else { ?>
                  <input class="form-control" type="file" disabled>
                <?php } ?>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                <?php if($info_upload['s_ugcertificate']=="") { ?>
                  <input class="form-control" type="file" name="s_ugcertificate" accept=".pdf" required>
                <?php } else { ?>
                  <input class="form-control" type="file" disabled>
                <?php } ?>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                <?php if($info_upload['s_ugmarksheet']=="") { ?>
                  <input class="form-control" type="file" name="s_ugmarksheet" accept=".pdf" required>
                <?php } else { ?>
                  <input class="form-control" type="file" disabled>
                <?php } ?>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              <?php if($info_upload['s_bankpassbook']=="") { ?>
                <input class="form-control" type="file" name="s_bankpassbook" accept=".pdf" required>
              <?php } else { ?>
                <input class="form-control" type="file" disabled>
              <?php } ?>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              <?php if($info_upload['s_extracarricular']=="") { ?>
                <input class="form-control" type="file" name="s_extracarricular" accept=".pdf" required>
              <?php } else { ?>
                <input class="form-control" type="file" disabled>
              <?php } ?>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              <?php if($info_upload['s_differentlyabled']=="") { ?>
                <input class="form-control" type="file" name="s_differentlyabled" accept=".pdf"required>
              <?php } else { ?>
                <input class="form-control" type="file" disabled>
              <?php } ?>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              <?php if($info_upload['s_ncccertificate']=="") { ?>
                <input class="form-control" type="file" name="s_ncc" accept=".pdf" required>
              <?php } else { ?>
                <input class="form-control" type="file" disabled>
              <?php } ?>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              <?php if($info_upload['s_castecertificate']=="") { ?>
                <input class="form-control" type="file" name="s_castecertificate" accept=".pdf" required>
              <?php } else { ?>
                <input class="form-control" type="file" disabled>
              <?php } ?>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              <?php if($info_upload['s_incomecertificate']=="") { ?>
                <input class="form-control" type="file" name="s_incomecertificate" accept=".pdf" required>
              <?php } else { ?>
                <input class="form-control" type="file" disabled>
              <?php } ?>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              <?php if($info_upload['s_domicilecertificate']=="") { ?>
                <input class="form-control" type="file" name="s_domicilecertificate" accept=".pdf" required>
              <?php } else { ?>
                <input class="form-control" type="file" disabled>
              <?php } ?>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              <?php if($info_upload['s_aadhaarcard']=="") { ?>
                <input class="form-control" type="file" name="s_aadhaarcard" accept=".pdf" required>
              <?php } else { ?>
                <input class="form-control" type="file" disabled>
              <?php } ?>
